...
func (g GoroutineSingle) Schedule(firstInMs int64, taskFun interface{}, params ...interface{}) (d system.IDisposable) {
	return g.scheduler.Schedule(firstInMs, taskFun, params...)
}

func (g GoroutineSingle) ScheduleOnInterval(firstInMs int64, regularInMs int64, taskFun interface{}, params ...interface{}) (d system.IDisposable) {
...
func (g *GoroutineSingle) RegisterSubscription(toAdd system.IDisposable) {
	g.subscriptions.Add(toAdd)
}

/*implement ISubscriptionRegistry.DeregisterSubscription */
func (g *GoroutineSingle) DeregisterSubscription(toRemove system.IDisposable) {
